...
$(function(){
	...
	//点击楼层直达
	$(".go-floor li").click(function(){
		var floor_top1=$("#first-floor").offset().top-78,
			floor_top2=$("#second-floor").offset().top-78,
			floor_top3=$("#third-floor").offset().top-78,
			//floor_top4=$("#forth-floor").offset().top-78,
			floor_top5=$("#fifth-floor").offset().top-78,
			li_index=$(this).index();

		if(li_index==0){
			$(window).scrollTop(floor_top1);
		}else if(li_index==1){
			$(window).scrollTop(floor_top2);
		}else if(li_index==2){
			$(window).scrollTop(floor_top3);
		}else if(li_index==3){
			$(window).scrollTop(floor_top5);
		}
	...
	$(window).scroll(function(){
		var offset_top=$(".third-part").offset().top-78;
		var floor_top2=$("#second-floor").offset().top-78,
			floor_top3=$("#third-floor").offset().top-78,
			//floor_top4=$("#forth-floor").offset().top-78,
			floor_top5=$("#fifth-floor").offset().top-78;
		...
		if(window_top>=offset_top){
			$(".third-part .navbar").addClass("scroll_fixed");

			 if(window_top>=floor_top5){

				$(".third-part .go-floor li:eq(3) a").addClass("select");
				$(".third-part .go-floor li:eq(3)").siblings("li").find("a").removeClass("select");
			}else if(window_top>=floor_top3){
				 $(".third-part .go-floor li:eq(2) a").addClass("select");
				 $(".third-part .go-floor li:eq(2)").siblings("li").find("a").removeClass("select");
			}else if(window_top>=floor_top2){
				 $(".third-part .go-floor li:eq(1) a").addClass("select");
				 $(".third-part .go-floor li:eq(1)").siblings("li").find("a").removeClass("select");
			}else{
				$(".third-part .go-floor li:eq(0) a").addClass("select");
				$(".third-part .go-floor li:eq(0)").siblings("li").find("a").removeClass("select");
			}
		}else{
			$(".third-part .navbar").removeClass("scroll_fixed");
		}
